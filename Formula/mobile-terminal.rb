class MobileTerminal < Formula
  ...
  def caveats
    <<~EOS
      To use mobile-terminal, run:
        mobile-terminal
      or the short version:
        mterm

      To broadcast a specific command:
        mterm npm install
        
      The terminal will show you a URL to open on your phone.
      Make sure both devices are on the same WiFi network.
    EOS
  end

  test do
    assert_match "The terminal moves with you", shell_output("#{bin}/mobile-terminal --help")
  end
end